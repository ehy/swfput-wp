    ...
    to  deal  with  them, no problem.  (in fact it is preferable
    that the shortcodes not be hand-edited.) The plugin adds  to
    ...
    Building From the Source
         ...
         The  source  directories  contain  simple Makefiles for
    building the .class files.  Makefile.unix is written for GNU
    gmake  but  is  probably  usable with no or few changes with
    most Unix  make  utilities.   Makefile.dos  is  written  for
    Symantec's  smake,  and might be a better starting point for
    other DOS make utilities.

         The makefiles have a target named "zip" for  generating
    a jar archive.
